...
const GYM_LEGACY_EXERCISES=[
 ...
 {id:"gym-ex-cindy",name:"Cindy",category:"другое",kind:"strength"},
...
const GYM_LEGACY_WORKOUTS=[
 ...
 {id:"gym-legacy-2026-08-21",date:"2026-08-21",startedAt:null,finishedAt:null,location:"home",type:"circuit",status:"finished",source:"confirmed-legacy",migrated:true,exercises:[
  legacyStrength("2026-08-21","cindy","gym-ex-cindy","Cindy","другое",[[0,15,"15 полных кругов за ~18–19 мин: 75 подтягиваний, 150 отжиманий, 225 приседаний."]])
 ]},
 ...
 {id:"gym-legacy-2026-09-24",date:"2026-09-24",startedAt:null,finishedAt:null,location:"home",type:"circuit",status:"finished",source:"confirmed-legacy",migrated:true,exercises:[
  legacyStrength("2026-09-24","cindy","gym-ex-cindy","Cindy","другое",[[0,18,"18 кругов за 20 минут."]])
 ]}
];
...
function gymRecordLabel(entry,set){if(entry.kind==='cardio')return `${set.distanceKm??'—'} км · ${formatTimer(set.durationSeconds||0)}`;return `${set.weightKg??'—'} кг × ${set.reps??'—'}`}
