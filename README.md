# MyOS V0.24.2 — Fitness и тренировки Кегеля

В V0.24.2 раздел «Фитнес / Тело» стал рабочим центром тренировок. Добавлена умеренно прогрессирующая программа Кегеля, устойчивый к уходу в background интервальный таймер и синхронизируемая история занятий.
