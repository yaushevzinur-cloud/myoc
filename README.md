# MyOS V0.24.1 — синхронизация и ежедневный дневник

В V0.24.1 добавлены синхронизируемые удаления книг через tombstone и дневник с независимыми утренним и вечерним ритуалами, историей по датам и серией дней.
